...
class LaneController:
    ...
    def compute_control_action(self, d_err, phi_err, dt, wheels_cmd_exec, stop_line_distance, slope):
        ...
        d_d = d_err - self.prev_d_err
        d_phi = phi_err - self.prev_phi_err
        k_d, k_theta = self.parameters['~k_d'].value, self.parameters['~k_theta'].value
        k_Id, k_Iphi = self.parameters['~k_Id'].value, self.parameters['~k_Iphi'].value
        k_dd, k_dphi = 0.2, 0.5
        ...
        # print(
        #     f"PID: d:{self.parameters['~k_d'].value, self.parameters['~k_Id'].value * self.d_I} phi:{self.parameters['~k_theta'].value, self.parameters['~k_Iphi'].value * self.phi_I}")
